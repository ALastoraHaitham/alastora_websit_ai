...
def get_answer(ask,lang):
    response = client.chat.completions.create(
        ...
        messages=[
            {
            "role": "system",
            "content": f"You will be provided with a piece of {lang} code, and your task is to find and fix bugs in it."
            },
            {
            "role": "user",
            "content": f"{ask}"
...
st.subheader("Create,find and fix bugs in source code in any prgramming language")
